...
The `absmaps` exists to make it easier to produce maps from ABS data in R. The package has two main components:
...
mapdata3 <- load_absmaps("sa3", year = 2016, download = TRUE, compress = 0.2)
...
<!-- # Correspond area data -->

<!-- Sometimes it is necessary... -->
<!-- We can use use `correspond_absmaps` to correspond the 2011 SA4s to 2016 SA4s. This function uses population-weighted correspondence tables provided by the ABS to distribute a number of people from one area to another.  -->

<!-- ```{r, eval = FALSE} -->
<!-- corr <- -->
<!-- correspond_absmaps(ue_data,  -->
<!--                   fromArea = "sa4", fromYear = 2011, -->
<!--                   toArea = "sa4", toYear = 2016, -->
<!--                   nVar = ue_pc, -->
<!--                   addGroup = year) -->
...
If you're interested, check out `download_absmaps.R` code in the `R/` file. And, of course, if you have a suggestion to improve, please do let me know via an issue at https://github.com/wfmackey/absmaps.
